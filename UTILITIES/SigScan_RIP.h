...
public:
	...
	SigScanner& FindPattern( byte* bMask, char* szMask )
	{
	...
	SigScanner& add( ptrdiff_t offset )
	{
		m_address_found += offset;
		return *this;
	}
	SigScanner& sub( ptrdiff_t offset )
	{
		m_address_found -= offset;
		return *this;
	}
...
int main()
{
	// Create an instance of the SigScanner class, passing the name of the module you want to scan as the parameter
	SigScanner ms( "example.exe" );
